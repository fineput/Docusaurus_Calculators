...
function Calculator() {
  ...
  return <div className="wrapper">
        <div className="header_container">
            ...
            <h1>Онлайн калькулятор. Периметр паралелограма</h1>
                ...
                <div className="content_data_container">
                    ...
                    <div className="content_data">
                        ...
                        <div className="content_flex">
                            ...
                            <h4 className='content_caption'>Введіть довжини сторін паралелограма:</h4>
...
function Instructions() {
  ...
  return <div className="content" id="Instuctions">
            <div className="content_data_container">
                <h3 className='instuctions_caption'>Ввід даних в калькулятор для обчислення периметра паралелограма</h3>
...
function Theory() {
  ...
  return <div>
    <div className="content" id="Theory">
            <h2 className="theory_caption">Теорія. Периметр паралелограма</h2>
            <div className="content_theory_container">
                ...
                <div className="theory_formula">
                    <h3 className="formula_caption">Периметр паралелограма ABCD дорівнює подвоєній сумі довжин сторін, прилеглих до одного кута</h3>
                    <p className="formula"><b>P = 2(a + b)</b></p>
                    <p className="formula_vol">
                      де P - периметр паралелограма,<br />
