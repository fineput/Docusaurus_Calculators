...
function Calculator() {
    ...
    const calculateArea = () => {
        ...
        if(isNaN(sideA) || isNaN(sideB)){
            ...
            const areaValue = Math.PI * sideA * sideB;
  ...
  return <div className="wrapper">
        <div className="header_container">
            ...
            <h1>Онлайн калькулятор. Площа еліпса</h1>
                    ...
                    <div className="content_data">
                        ...
                        <div className="content_flex">
                            ...
                            <div className="a" id="a">
                                <label for="a">a: </label>
                                <input type="number" value={a} onChange={(e) => setA(Number(e.target.value))} placeholder='Довжина великої піввісі'/>
                            </div>

                            <div className="b" id="b">
                                <label for="b">b: </label>
                                <input type="number" value={b} onChange={(e) => setB(Number(e.target.value))} placeholder='Довжина малої піввісі'/>
                            </div>
...
function Instructions() {
  ...
  return <div className="content" id="Instuctions">
            <div className="content_data_container">
                <h2>Ввід даних в калькулятор для обчислення площі еліпса</h2>
...
function Theory() {
  ...
  return <div>
    <div className="content" id="Theory">
            <h2 className="theory_caption">Теорія. Площа еліпса</h2>
            <div className="content_theory_container">

                <div className="content_theory">
                    <p className="theory_descr"><b>Трапеція</b> - геометричне місце точок, сума відстаней, від яких до двох заданих точок F<sub>1</sub> і F<sub>2</sub>, які називаються фокусами еліпса, є стала величина, більша ніж відстань між цими точками F<sub>1</sub>F<sub>2</sub>. Коло є частковим випадком еліпса.</p>

                </div>
               
                <div className="theory_formula">
                    <h3 className="formula_caption"> Формула для обчислення площі еліпса:</h3>
                    <p className="formula"><b>S = π · a · b</b></p>
                    <p className="formula_vol">
                        де S - площа еліпса,<br />
                        a - довжина великої піввісі еліпса,<br />
                        b - довжина малої піввісі еліпса,<br />
                        π = 3.141592.
                    </p>
                </div>
